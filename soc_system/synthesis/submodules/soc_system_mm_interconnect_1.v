...
module soc_system_mm_interconnect_1 (
	...
	wire  [129:0] alt_vip_vfr_0_avalon_slave_agent_rf_source_data;                                    // alt_vip_vfr_0_avalon_slave_agent:rf_source_data -> alt_vip_vfr_0_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [129:0] alt_vip_vfr_0_avalon_slave_agent_rsp_fifo_out_data;                                 // alt_vip_vfr_0_avalon_slave_agent_rsp_fifo:out_data -> alt_vip_vfr_0_avalon_slave_agent:rf_sink_data
	...
	wire          alt_vip_vfr_0_avalon_slave_agent_rp_valid;                                          // alt_vip_vfr_0_avalon_slave_agent:rp_valid -> router_012:sink_valid
	wire  [128:0] alt_vip_vfr_0_avalon_slave_agent_rp_data;                                           // alt_vip_vfr_0_avalon_slave_agent:rp_data -> router_012:sink_data
	wire          alt_vip_vfr_0_avalon_slave_agent_rp_ready;                                          // router_012:sink_ready -> alt_vip_vfr_0_avalon_slave_agent:rp_ready
	wire          alt_vip_vfr_0_avalon_slave_agent_rp_startofpacket;                                  // alt_vip_vfr_0_avalon_slave_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire          alt_vip_vfr_0_avalon_slave_agent_rp_endofpacket;                                    // alt_vip_vfr_0_avalon_slave_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> alt_vip_vfr_0_avalon_slave_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> alt_vip_vfr_0_avalon_slave_burst_adapter:sink0_data
	wire          cmd_mux_007_src_ready;                                                              // alt_vip_vfr_0_avalon_slave_burst_adapter:sink0_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> alt_vip_vfr_0_avalon_slave_burst_adapter:sink0_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> alt_vip_vfr_0_avalon_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> alt_vip_vfr_0_avalon_slave_burst_adapter:sink0_endofpacket
	...
	wire  [128:0] alt_vip_vfr_0_avalon_slave_burst_adapter_source0_data;                              // alt_vip_vfr_0_avalon_slave_burst_adapter:source0_data -> alt_vip_vfr_0_avalon_slave_agent:cp_data
	...
	wire          cmd_demux_003_src5_valid;                                                           // cmd_demux_003:src5_valid -> crosser:in_valid
	wire  [128:0] cmd_demux_003_src5_data;                                                            // cmd_demux_003:src5_data -> crosser:in_data
	wire          cmd_demux_003_src5_ready;                                                           // crosser:in_ready -> cmd_demux_003:src5_ready
	wire    [7:0] cmd_demux_003_src5_channel;                                                         // cmd_demux_003:src5_channel -> crosser:in_channel
	wire          cmd_demux_003_src5_startofpacket;                                                   // cmd_demux_003:src5_startofpacket -> crosser:in_startofpacket
	wire          cmd_demux_003_src5_endofpacket;                                                     // cmd_demux_003:src5_endofpacket -> crosser:in_endofpacket
	wire          crosser_out_valid;                                                                  // crosser:out_valid -> cmd_mux_007:sink0_valid
	wire  [128:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux_007:sink0_data
	wire          crosser_out_ready;                                                                  // cmd_mux_007:sink0_ready -> crosser:out_ready
	wire    [7:0] crosser_out_channel;                                                                // crosser:out_channel -> cmd_mux_007:sink0_channel
	...
	wire          cmd_demux_004_src5_valid;                                                           // cmd_demux_004:src5_valid -> crosser_001:in_valid
	wire  [128:0] cmd_demux_004_src5_data;                                                            // cmd_demux_004:src5_data -> crosser_001:in_data
	wire          cmd_demux_004_src5_ready;                                                           // crosser_001:in_ready -> cmd_demux_004:src5_ready
	wire    [7:0] cmd_demux_004_src5_channel;                                                         // cmd_demux_004:src5_channel -> crosser_001:in_channel
	wire          cmd_demux_004_src5_startofpacket;                                                   // cmd_demux_004:src5_startofpacket -> crosser_001:in_startofpacket
	wire          cmd_demux_004_src5_endofpacket;                                                     // cmd_demux_004:src5_endofpacket -> crosser_001:in_endofpacket
	wire          crosser_001_out_valid;                                                              // crosser_001:out_valid -> cmd_mux_007:sink1_valid
	wire  [128:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux_007:sink1_data
	wire          crosser_001_out_ready;                                                              // cmd_mux_007:sink1_ready -> crosser_001:out_ready
	wire    [7:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_007:sink1_channel
	...
	wire  [128:0] rsp_demux_007_src0_data;                                                            // rsp_demux_007:src0_data -> crosser_002:in_data
	wire          rsp_demux_007_src0_ready;                                                           // crosser_002:in_ready -> rsp_demux_007:src0_ready
	wire    [7:0] rsp_demux_007_src0_channel;                                                         // rsp_demux_007:src0_channel -> crosser_002:in_channel
	...
	wire          crosser_002_out_valid;                                                              // crosser_002:out_valid -> rsp_mux_003:sink5_valid
	wire  [128:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux_003:sink5_data
	wire          crosser_002_out_ready;                                                              // rsp_mux_003:sink5_ready -> crosser_002:out_ready
	wire    [7:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux_003:sink5_channel
	wire          crosser_002_out_startofpacket;                                                      // crosser_002:out_startofpacket -> rsp_mux_003:sink5_startofpacket
	wire          crosser_002_out_endofpacket;                                                        // crosser_002:out_endofpacket -> rsp_mux_003:sink5_endofpacket
	wire          rsp_demux_007_src1_valid;                                                           // rsp_demux_007:src1_valid -> crosser_003:in_valid
	wire  [128:0] rsp_demux_007_src1_data;                                                            // rsp_demux_007:src1_data -> crosser_003:in_data
	wire          rsp_demux_007_src1_ready;                                                           // crosser_003:in_ready -> rsp_demux_007:src1_ready
	wire    [7:0] rsp_demux_007_src1_channel;                                                         // rsp_demux_007:src1_channel -> crosser_003:in_channel
	...
	wire          crosser_003_out_valid;                                                              // crosser_003:out_valid -> rsp_mux_004:sink5_valid
	wire  [128:0] crosser_003_out_data;                                                               // crosser_003:out_data -> rsp_mux_004:sink5_data
	wire          crosser_003_out_ready;                                                              // rsp_mux_004:sink5_ready -> crosser_003:out_ready
	wire    [7:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_004:sink5_channel
	wire          crosser_003_out_startofpacket;                                                      // crosser_003:out_startofpacket -> rsp_mux_004:sink5_startofpacket
	wire          crosser_003_out_endofpacket;                                                        // crosser_003:out_endofpacket -> rsp_mux_004:sink5_endofpacket
	...
	wire          alt_vip_vfr_0_avalon_slave_agent_rdata_fifo_out_valid;                              // alt_vip_vfr_0_avalon_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] alt_vip_vfr_0_avalon_slave_agent_rdata_fifo_out_data;                               // alt_vip_vfr_0_avalon_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_007:in_0_data
	wire          alt_vip_vfr_0_avalon_slave_agent_rdata_fifo_out_ready;                              // avalon_st_adapter_007:in_0_ready -> alt_vip_vfr_0_avalon_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> alt_vip_vfr_0_avalon_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> alt_vip_vfr_0_avalon_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // alt_vip_vfr_0_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> alt_vip_vfr_0_avalon_slave_agent:rdata_fifo_sink_error
	...
	soc_system_mm_interconnect_1_router_006 router_009 (
	...
	soc_system_mm_interconnect_1_router_006 router_010 (
	...
	soc_system_mm_interconnect_1_router_006 router_011 (
	...
	soc_system_mm_interconnect_1_cmd_mux_001 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_cmd_mux_001 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_rsp_demux_001 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
