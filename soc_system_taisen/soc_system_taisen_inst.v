	soc_system_taisen u0 (
		...
		.clk_lvds_lcd_clk                      (<connected-to-clk_lvds_lcd_clk>),                      //                   clk_lvds_lcd.clk
		...
		.lvds_video_out_vid_clk                (<connected-to-lvds_video_out_vid_clk>),                //                 lvds_video_out.vid_clk
		.lvds_video_out_vid_data               (<connected-to-lvds_video_out_vid_data>),               //                               .vid_data
		.lvds_video_out_underflow              (<connected-to-lvds_video_out_underflow>),              //                               .underflow
		.lvds_video_out_vid_datavalid          (<connected-to-lvds_video_out_vid_datavalid>),          //                               .vid_datavalid
		.lvds_video_out_vid_v_sync             (<connected-to-lvds_video_out_vid_v_sync>),             //                               .vid_v_sync
		.lvds_video_out_vid_h_sync             (<connected-to-lvds_video_out_vid_h_sync>),             //                               .vid_h_sync
		.lvds_video_out_vid_f                  (<connected-to-lvds_video_out_vid_f>),                  //                               .vid_f
		.lvds_video_out_vid_h                  (<connected-to-lvds_video_out_vid_h>),                  //                               .vid_h
		.lvds_video_out_vid_v                  (<connected-to-lvds_video_out_vid_v>),                  //                               .vid_v
